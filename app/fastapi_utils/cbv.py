# based on: https://github.com/dmontagu/fastapi-utils/blob/master/fastapi_utils/cbv.py

import inspect
from typing import Any, Callable, Dict, List, Sequence, Type, TypeVar, Union, get_type_hints, Optional, Sequence, Dict, Type
...
def cbv(router: APIRouter,
    ...
    def decorator(cls: Type[T]) -> Type[T]:
        router_options = dict(prefix=prefix,
                              tags=tags,
                              dependencies=dependencies,
                              responses=responses,
                              default_response_class=default_response_class)
        return _cbv(router, cls, router_options=router_options)

    return decorator


def _cbv(router: APIRouter, cls: Type[T], router_options: Dict[str, Any]) -> Type[T]:
    """
    ...
    router.include_router(cbv_router, **router_options)
    return cls
